...
def faq_get():
    ...
    faqs = [(
        ...
        "Where do the recipes come from?", "Most of them are directly taken or adapted from [BBC goodfood](https://www.bbcgoodfood.com/), but you can send me more that you like leaflet@craigmulligan.com"
    )]
