"""drop shopping_list_item

Revision ID: 73f9697df281
Revises: 69365fb5757e
Create Date: 2024-05-17 14:43:53.341674
...
revision: str = '73f9697df281'
down_revision: Union[str, None] = '69365fb5757e'
...
def upgrade() -> None:
    ...
    op.create_table('recipe_embedding',
    sa.Column('id', sa.Integer(), nullable=False),
